...
class SlectivCreative extends StatelessWidget {
  const SlectivCreative({super.key});
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(SlectivTexts.widePhotoboxTitle, style: GoogleFonts.spaceGrotesk(textStyle: const TextStyle(fontSize: 20, fontWeight: FontWeight.w700, color: SlectivColors.blackColor)),),
              ...
              SlectiveWidgetButton(buttonName: "Contact Us", onPressed: (){}, backgroundColor: SlectivColors.forgetPasswordButtonColor),
